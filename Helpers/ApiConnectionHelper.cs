    ...
    internal class ApiConnectionHelper
    {
        ...
        public static async Task<List<MediaModel>> FetchMoviesFromApi()
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                Headers =
                {
                    { "X-RapidAPI-Key", SecurityHelper.DecryptString(ConfigurationManager.AppSettings["ApiKey1"]) },
        ...
        public async static Task<TargetDetailModel> FetchTargetDetailsFromApi(string netflixId)
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                Headers =
                {
                    { "X-RapidAPI-Key", SecurityHelper.DecryptString(ConfigurationManager.AppSettings["ApiKey2"]) },
                    { "X-RapidAPI-Host", "unogs-unogs-v1.p.rapidapi.com" },
                },
            };
